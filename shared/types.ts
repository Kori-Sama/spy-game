...
export interface ServerToClientEvents {
    ...
    vote_updated: (data: { room: GameRoom, votes: Record<string, string> }) => void;
...
export interface ClientToServerEvents {
    ...
    // 主持人操作
    update_room_config: (data: { roomId: string, config: Partial<RoomConfig> }) => void;
    assign_roles: (data: { roomId: string, assignments?: Record<string, PlayerRole> }) => void; // 为空则随机分配
